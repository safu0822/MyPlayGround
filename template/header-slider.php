<?php
// JSONファイルのパスを取得（ファイルパス）
$json_file = get_template_directory() . '/assets/json/topPageSlide/header-slider.json';
      ...
      <li class="bg-dark-30 bg-dark"
        ...
        <div class="titan-caption">
          <div class="caption-content">
            ...
            <a class="font-yosugara section-scroll btn btn-border-w btn-round"
              href="<?php echo esc_url( home_url( '#activity' ) ); ?>">Learn More</a>
          </div>
        </div>
      </li>
      <?php endforeach; ?>
